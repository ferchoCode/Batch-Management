...
@section('content')
    <section class="section">
        <div class="section-header mb-4 d-flex justify-content-between">
            <h1 class="page__heading">VENTA DE PAQUETES </h1>
            <a href="{{url('ventapaquete/create')}}" class="btn btn-primary ml-2">Nuevo</a>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-12">
                                    <div class="tabla">
                                        @include('venta-paquete.tabla')
                                    </div>
                                </div>

                                {{-- <div class="col-12">
                                    <div class="order">
                                        @include('venta-paquete.order')
                                    </div>
                                </div> --}}
                            </div>

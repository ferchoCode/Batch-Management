    ...
    <div class="datagrid">
        <table>
            ...
            <tbody class="border border-1">
                @foreach ($ventapaquete as $ventapaquetes)
                    <tr>
                        {{-- <th scope="row">{{$loop->iteration}}</th>s --}}


                        <td class="border border-1">{{ $ventapaquetes->socio }}</td>
                        <td class="border border-1">{{ $ventapaquetes->paquete }}</td>
                        <td class="border border-1">{{ $ventapaquetes->monto }}</td>
                        <td>{{ $ventapaquetes->fecha}}</td>



                        <td>
                          
                                <a href="{{url('ventapaquete/'.$ventapaquetes->id.'/order_pdf')}}" class="btn  btn-icon btn-info btn-sm mr-2"><i class="fa-solid fa-print"></i></a>
